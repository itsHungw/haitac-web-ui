  ...
  return (
    <footer className="site-footer">
      ...
      <div className="page-width footer-grid">
        ...
        <div><h3>Cộng đồng</h3><a href="https://haitactihon.com/forum" target="_blank" rel="noopener noreferrer">Diễn đàn</a><a href="https://www.facebook.com/ht.teamobi" target="_blank" rel="noopener noreferrer">Fanpage</a><a href="/nap-the">Nạp ruby</a></div>
      </div>
