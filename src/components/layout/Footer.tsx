  ...
  return (
    <footer className="site-footer">
      ...
      <div className="page-width footer-grid">
        ...
        <div><h3>Cộng đồng</h3><a href="/dien-dan">Diễn đàn</a><a href="https://www.facebook.com/ht.teamobi" target="_blank" rel="noopener noreferrer">Fanpage</a><a href="/nap-the">Nạp Coin</a></div>
      </div>
